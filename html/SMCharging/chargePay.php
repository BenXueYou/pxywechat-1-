                   ...
                   WeixinJSBridge.invoke(
                       ...
                       function(res){
                           ...
                           //支付成功
                               ...
                               //alert("跳转之前chargeState="+chargeState+"money="+money+"cpId"+cpid);
                               location.href='../SMCharging/charging.php?cpid='+cpid+'&openId='+openId+"&chargeState="+chargeState+"&payMode="+payMode+"&money="+money+"&outTradeNo="+outTradeNo;
							   $("#middle_input").attr("value","");
